...
public class PatientPanel extends Activity {
	...
	public static final String TAG = "com.ecruit.hospital.Patient";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.patientpanel);
		...
		//getting the list of doctor 
		List<Doctors> doclist=dbHandler.getAllDoctors();
		
		ArrayAdapter<Doctors> dataAdapter = new ArrayAdapter<Doctors>(this,
